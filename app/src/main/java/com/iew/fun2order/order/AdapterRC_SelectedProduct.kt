...
class AdapterRC_SelectedProduct(var context: Context, var lstItemsSelectedMenuProduct: List<MENU_PRODUCT>, val IAdapterOnClick: IAdapterOnClick) : RecyclerView.Adapter<AdapterRC_SelectedProduct.ViewHolder>() {
