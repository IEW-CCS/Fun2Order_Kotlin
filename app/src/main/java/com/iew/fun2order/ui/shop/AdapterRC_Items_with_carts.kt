...
class AdapterRC_Items_with_carts(var context: Context, var lstProductItems : List<ItemsLV_Products>, private val lstPriceSequenct: List<String>, val IAdapterOnClick: IAdapterOnClick) : RecyclerView.Adapter<AdapterRC_Items_with_carts.ViewHolder>()
{
