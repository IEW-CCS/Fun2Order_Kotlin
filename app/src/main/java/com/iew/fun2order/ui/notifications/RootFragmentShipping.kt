...
class RootFragmentShipping() : Fragment() ,IAdapterOnClick  {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        notificationDB.getAllShipping().observe(viewLifecycleOwner, Observer { notify ->
            ...
            if(lstNotification[pos] is ItemsLV_Notify) {
                ...
                when (objIntentNotify!!.notificationType) {
                    NOTIFICATION_TYPE_SHIPPING_NOTICE -> {
                        ...
                        val intent = Intent(context, ActivityTapShipping::class.java)
